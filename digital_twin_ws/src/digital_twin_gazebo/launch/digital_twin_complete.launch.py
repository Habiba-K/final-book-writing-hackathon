...
"""
Complete launch file for digital twin simulation
Integrates all components: robot model, sensors, controllers, and visualization
"""
...
def generate_launch_description():
    ...
    rviz = Node(
        ...
        condition=lambda context: context.launch_configurations.get('use_rviz', 'true') == 'true'
    )
